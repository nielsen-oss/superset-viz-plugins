...
const BarsTemplate = (args) => {
  ...
  return <ThemeProvider theme={supersetTheme}><ComposedChart
    ...
    data={transformProps({...barsHorizontalLegendTop, queriesData: args.queriesData} as unknown as ChartProps).data}
  /></ThemeProvider>
};

const LinesTemplate = (args) => {
  if (args.chartSubType !== CHART_SUB_TYPES.BASIS
...
const ScatterTemplate = (args) => {
  if (args.chartSubType !== CHART_SUB_TYPES.CIRCLE
